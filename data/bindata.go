...
func dataRatesJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "data/rates.json", size: 333, mode: os.FileMode(436), modTime: time.Unix(1495217254, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
